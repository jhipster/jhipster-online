...
@Service
public class BitbucketService implements GitProviderService {
    ...
    public BitbucketService(GeneratorService generatorService,
    ...
    public void init() {
        if (isEnabled()) {
            if (this.applicationProperties.getBitbucket().getHost().equals("https://bitbucket.org")) {
                log.warn("JHipster Online is configured to work on the public Bitbucket instance at https://bitbucket.org");
            } else {
                log.warn("JHipster Online is configured to work on a private Bitbucket instance at {}", this.applicationProperties.getBitbucket().getHost());
            }
        }
    }
    ...
    public String getHost() {
        return applicationProperties.getBitbucket().getHost();
    }

    @Override
    public String getClientId() { return applicationProperties.getBitbucket().getClientId(); }

    public String getRedirectUri() {
        return applicationProperties.getBitbucket().getRedirectUri();
    }

    @Override
    public boolean isEnabled() {
        return
            this.applicationProperties.getBitbucket().getClientId() != null &&
                this.applicationProperties.getBitbucket().getClientSecret() != null &&
                this.applicationProperties.getBitbucket().getHost() != null &&
                this.applicationProperties.getBitbucket().getRedirectUri() != null;
    }
