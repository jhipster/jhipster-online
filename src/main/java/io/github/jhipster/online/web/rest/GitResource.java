...
public class GitResource {
    ...
    public GitResource(ApplicationProperties applicationProperties, UserService userService, GithubService
        githubService, GitlabService gitlabService) {
