    ...
    describe('SubGenEvent Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sub-gen-events';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a SubGenEvent', () => {
                service.create(new SubGenEvent(null)).subscribe(received => {
            ...
            it('should update a SubGenEvent', () => {
                service.update(new SubGenEvent(123)).subscribe(received => {
            ...
            it('should return a SubGenEvent', () => {
