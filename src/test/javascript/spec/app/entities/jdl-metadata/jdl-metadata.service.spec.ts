    ...
    describe('JdlMetadata Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/jdl-metadata';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a JdlMetadata', () => {
                service.create(new JdlMetadata(null)).subscribe(received => {
            ...
            it('should update a JdlMetadata', () => {
                service.update(new JdlMetadata(123)).subscribe(received => {
            ...
            it('should return a JdlMetadata', () => {
