    ...
    describe('UserApplication Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-applications';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a UserApplication', () => {
                service.create(new UserApplication(null)).subscribe(received => {
            ...
            it('should update a UserApplication', () => {
                service.update(new UserApplication(123)).subscribe(received => {
            ...
            it('should return a UserApplication', () => {
            ...
            it('should return a list of UserApplication', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new UserApplication(123)]);
            });
