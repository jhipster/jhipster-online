    ...
    describe('YoRC Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/yo-rcs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a YoRC', () => {
                service.create(new YoRC(null)).subscribe(received => {
            ...
            it('should update a YoRC', () => {
                service.update(new YoRC(123)).subscribe(received => {
