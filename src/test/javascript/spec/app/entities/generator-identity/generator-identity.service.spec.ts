    ...
    describe('GeneratorIdentity Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/generator-identities';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a GeneratorIdentity', () => {
                service.create(new GeneratorIdentity(null)).subscribe(received => {
            ...
            it('should update a GeneratorIdentity', () => {
                service.update(new GeneratorIdentity(123)).subscribe(received => {
            ...
            it('should return a GeneratorIdentity', () => {
            ...
            it('should return a list of GeneratorIdentity', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new GeneratorIdentity(123)]);
            });
