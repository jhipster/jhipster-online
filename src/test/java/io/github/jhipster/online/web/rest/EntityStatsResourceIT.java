...
/**
 * Integration tests for the {@link EntityStatsResource} REST controller.
 */
@SpringBootTest(classes = JhonlineApp.class)

@AutoConfigureMockMvc
@WithMockUser
public class EntityStatsResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static EntityStats createUpdatedEntity(EntityManager em) {
        EntityStats entityStats = new EntityStats()
            .year(UPDATED_YEAR)
            .month(UPDATED_MONTH)
            .week(UPDATED_WEEK)
