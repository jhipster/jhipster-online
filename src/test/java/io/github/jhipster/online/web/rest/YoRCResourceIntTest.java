...
public class YoRCResourceIntTest {
    ...
    private static final String DEFAULT_ENABLE_HIBERNATE_CACHE = "AAAAAAAAAA";
    private static final String UPDATED_ENABLE_HIBERNATE_CACHE = "BBBBBBBBBB";

    private static final String DEFAULT_WEBSOCKET = "AAAAAAAAAA";
    private static final String UPDATED_WEBSOCKET = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_SEARCH_ENGINE = "AAAAAAAAAA";
    private static final String UPDATED_SEARCH_ENGINE = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_ENABLE_SWAGGER_CODEGEN = "AAAAAAAAAA";
    private static final String UPDATED_ENABLE_SWAGGER_CODEGEN = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_USE_SASS = "AAAAAAAAAA";
    private static final String UPDATED_USE_SASS = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_TEST_FRAMEWORKS = "AAAAAAAAAA";
    private static final String UPDATED_TEST_FRAMEWORKS = "BBBBBBBBBB";

    private static final String DEFAULT_JHI_PREFIX = "AAAAAAAAAA";
    private static final String UPDATED_JHI_PREFIX = "BBBBBBBBBB";

    private static final String DEFAULT_ENABLE_TRANSLATION = "AAAAAAAAAA";
    private static final String UPDATED_ENABLE_TRANSLATION = "BBBBBBBBBB";
    ...
    @Mock
    private YoRCRepository yoRCRepositoryMock;
    
    @Mock
    private YoRCService yoRCServiceMock;
    ...
    public static YoRC createEntity(EntityManager em) {
        YoRC yoRC = new YoRC()
            ...
            .testFrameworks(DEFAULT_TEST_FRAMEWORKS)
    ...
    public void createYoRC() throws Exception {
        ...
        assertThat(testYoRC.getEnableHibernateCache()).isEqualTo(DEFAULT_ENABLE_HIBERNATE_CACHE);
        assertThat(testYoRC.getWebsocket()).isEqualTo(DEFAULT_WEBSOCKET);
        ...
        assertThat(testYoRC.getSearchEngine()).isEqualTo(DEFAULT_SEARCH_ENGINE);
        assertThat(testYoRC.getMessageBroker()).isEqualTo(DEFAULT_MESSAGE_BROKER);
        assertThat(testYoRC.getServiceDiscoveryType()).isEqualTo(DEFAULT_SERVICE_DISCOVERY_TYPE);
        assertThat(testYoRC.getBuildTool()).isEqualTo(DEFAULT_BUILD_TOOL);
        assertThat(testYoRC.getEnableSwaggerCodegen()).isEqualTo(DEFAULT_ENABLE_SWAGGER_CODEGEN);
        assertThat(testYoRC.getClientFramework()).isEqualTo(DEFAULT_CLIENT_FRAMEWORK);
        assertThat(testYoRC.getUseSass()).isEqualTo(DEFAULT_USE_SASS);
        ...
        assertThat(testYoRC.getTestFrameworks()).isEqualTo(DEFAULT_TEST_FRAMEWORKS);
        assertThat(testYoRC.getJhiPrefix()).isEqualTo(DEFAULT_JHI_PREFIX);
        assertThat(testYoRC.getEnableTranslation()).isEqualTo(DEFAULT_ENABLE_TRANSLATION);
    ...
    public void getAllYoRCS() throws Exception {
        ...
        restYoRCMockMvc.perform(get("/api/yo-rcs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].enableHibernateCache").value(hasItem(DEFAULT_ENABLE_HIBERNATE_CACHE.toString())))
            .andExpect(jsonPath("$.[*].websocket").value(hasItem(DEFAULT_WEBSOCKET.toString())))
            ...
            .andExpect(jsonPath("$.[*].searchEngine").value(hasItem(DEFAULT_SEARCH_ENGINE.toString())))
            .andExpect(jsonPath("$.[*].messageBroker").value(hasItem(DEFAULT_MESSAGE_BROKER.toString())))
            .andExpect(jsonPath("$.[*].serviceDiscoveryType").value(hasItem(DEFAULT_SERVICE_DISCOVERY_TYPE.toString())))
            .andExpect(jsonPath("$.[*].buildTool").value(hasItem(DEFAULT_BUILD_TOOL.toString())))
            .andExpect(jsonPath("$.[*].enableSwaggerCodegen").value(hasItem(DEFAULT_ENABLE_SWAGGER_CODEGEN.toString())))
            .andExpect(jsonPath("$.[*].clientFramework").value(hasItem(DEFAULT_CLIENT_FRAMEWORK.toString())))
            .andExpect(jsonPath("$.[*].useSass").value(hasItem(DEFAULT_USE_SASS.toString())))
            ...
            .andExpect(jsonPath("$.[*].testFrameworks").value(hasItem(DEFAULT_TEST_FRAMEWORKS.toString())))
            .andExpect(jsonPath("$.[*].jhiPrefix").value(hasItem(DEFAULT_JHI_PREFIX.toString())))
            .andExpect(jsonPath("$.[*].enableTranslation").value(hasItem(DEFAULT_ENABLE_TRANSLATION.toString())))
    ...
    public void getAllYoRCSWithEagerRelationshipsIsEnabled() throws Exception {
        YoRCResource yoRCResource = new YoRCResource(yoRCServiceMock);
        when(yoRCServiceMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));

        MockMvc restYoRCMockMvc = MockMvcBuilders.standaloneSetup(yoRCResource)
            .setCustomArgumentResolvers(pageableArgumentResolver)
            .setControllerAdvice(exceptionTranslator)
            .setConversionService(createFormattingConversionService())
            .setMessageConverters(jacksonMessageConverter).build();

        restYoRCMockMvc.perform(get("/api/yo-rcs?eagerload=true"))
        .andExpect(status().isOk());

        verify(yoRCServiceMock, times(1)).findAllWithEagerRelationships(any());
    }

    public void getAllYoRCSWithEagerRelationshipsIsNotEnabled() throws Exception {
        YoRCResource yoRCResource = new YoRCResource(yoRCServiceMock);
            when(yoRCServiceMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
            MockMvc restYoRCMockMvc = MockMvcBuilders.standaloneSetup(yoRCResource)
            .setCustomArgumentResolvers(pageableArgumentResolver)
    ...
    public void getYoRC() throws Exception {
        ...
        restYoRCMockMvc.perform(get("/api/yo-rcs/{id}", yoRC.getId()))
            ...
            .andExpect(jsonPath("$.enableHibernateCache").value(DEFAULT_ENABLE_HIBERNATE_CACHE.toString()))
            .andExpect(jsonPath("$.websocket").value(DEFAULT_WEBSOCKET.toString()))
            ...
            .andExpect(jsonPath("$.searchEngine").value(DEFAULT_SEARCH_ENGINE.toString()))
            .andExpect(jsonPath("$.messageBroker").value(DEFAULT_MESSAGE_BROKER.toString()))
            .andExpect(jsonPath("$.serviceDiscoveryType").value(DEFAULT_SERVICE_DISCOVERY_TYPE.toString()))
            .andExpect(jsonPath("$.buildTool").value(DEFAULT_BUILD_TOOL.toString()))
            .andExpect(jsonPath("$.enableSwaggerCodegen").value(DEFAULT_ENABLE_SWAGGER_CODEGEN.toString()))
            .andExpect(jsonPath("$.clientFramework").value(DEFAULT_CLIENT_FRAMEWORK.toString()))
            .andExpect(jsonPath("$.useSass").value(DEFAULT_USE_SASS.toString()))
            ...
            .andExpect(jsonPath("$.testFrameworks").value(DEFAULT_TEST_FRAMEWORKS.toString()))
            .andExpect(jsonPath("$.jhiPrefix").value(DEFAULT_JHI_PREFIX.toString()))
            .andExpect(jsonPath("$.enableTranslation").value(DEFAULT_ENABLE_TRANSLATION.toString()))
    ...
    public void updateYoRC() throws Exception {
        ...
        updatedYoRC
            ...
            .testFrameworks(UPDATED_TEST_FRAMEWORKS)
        ...
        assertThat(testYoRC.getEnableHibernateCache()).isEqualTo(UPDATED_ENABLE_HIBERNATE_CACHE);
        assertThat(testYoRC.getWebsocket()).isEqualTo(UPDATED_WEBSOCKET);
        ...
        assertThat(testYoRC.getSearchEngine()).isEqualTo(UPDATED_SEARCH_ENGINE);
        assertThat(testYoRC.getMessageBroker()).isEqualTo(UPDATED_MESSAGE_BROKER);
        assertThat(testYoRC.getServiceDiscoveryType()).isEqualTo(UPDATED_SERVICE_DISCOVERY_TYPE);
        assertThat(testYoRC.getBuildTool()).isEqualTo(UPDATED_BUILD_TOOL);
        assertThat(testYoRC.getEnableSwaggerCodegen()).isEqualTo(UPDATED_ENABLE_SWAGGER_CODEGEN);
        assertThat(testYoRC.getClientFramework()).isEqualTo(UPDATED_CLIENT_FRAMEWORK);
        assertThat(testYoRC.getUseSass()).isEqualTo(UPDATED_USE_SASS);
        ...
        assertThat(testYoRC.getTestFrameworks()).isEqualTo(UPDATED_TEST_FRAMEWORKS);
        assertThat(testYoRC.getJhiPrefix()).isEqualTo(UPDATED_JHI_PREFIX);
        assertThat(testYoRC.getEnableTranslation()).isEqualTo(UPDATED_ENABLE_TRANSLATION);
